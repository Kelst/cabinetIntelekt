...
async checkAuth(){
 ...
 async checkBillingApi(){
  try {
  const user= await axios.get(`http://194.8.147.150:5000/api/checkIpBilling?provider=${'Intelekt'}`)
  if(user.status=='200'){
return user.data
  } else {
...
async requestPhoneChange(uid,login,newPhone) {
  try {
    const response = await $api.post('http://194.8.147.150:5000/api/request-phone-change', { uid,login,newPhone})
    const result = response.data
    return result
  } catch (error) {
    console.error("Error clear cid:", error)
...
async addAdditionalService(uid,login,phone,description) {
  try {
    ...
    const response = await $api.post('http://194.8.147.150:5000/api/addAdditionalService', { uid, login, phone,description });
    const result = response.data;
    return result;
  } catch (error) {
    console.error("Error changeTariffPlan:", error);
...
async addStaticRequest(login,phone) {
  try {
    ...
    const response = await $api.post('http://194.8.147.150:5000/api/addStaticRequest', {login, phone });
    const result = response.data;
    return result;
  } catch (error) {
...
async addFeedBack(feedBack,phone,login) {
  try {
    ...
    const response = await $api.post('http://194.8.147.150:5000/api/addFeedback', {feedBack,phone,login,provider:"Intelekt" });
    const result = response.data;
    return result;
  } catch (error) {
