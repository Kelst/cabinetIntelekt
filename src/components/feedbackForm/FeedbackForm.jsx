  ...
  if (submitted || submitError) {
    return (
      ...
      >
        ...
        >
          {submitted ? (
            <Typography variant="h5" sx={{ color: '#4CAF50', mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
              <CommentRounded />
              Дякуємо за ваш відгук!
            </Typography>
          ) : (
            <Typography variant="h5" sx={{ color: '#ff0000', mb: 2, display: 'flex', alignItems: 'center', gap: 1 }}>
              <ErrorOutline />
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <CommentRounded sx={{ color: '#ff0000' }} />
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <Button
                ...
                sx={{
                  py: 1.5,
                  backgroundColor: canSubmit ? '#ff0000' : '#cccccc',
                  '&:hover': {
                    backgroundColor: canSubmit ? '#d32f2f' : '#cccccc',
                  },
                }}
                disabled={!canSubmit}
              >
