...
const handleSetCredit= async()=>{
  ...
  try {
    setLoader(true)
     ...
     console.log(result,"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjE0MDI3OCwiaWQiOiJ2bGFkX2JfMSIsImlhdCI6MTczMDI3ODcyNSwiZXhwIjoxNzMwMjgwNTI1fQ.8_GLB6d_2wepfUPplNMpctWZWydae-55GmXFtOgDt90eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1aWQiOjE0MDI3OCwiaWQiOiJ2bGFkX2JfMSIsImlhdCI6MTczMDI3ODcyNSwiZXhwIjoxNzMwMjgwNTI1fQ.8_GLB6d_2wepfUPplNMpctWZWydae-55GmXFtOgDt90");
