        ...
        <div className="p-6 space-y-6 text-gray-800">
          ...
          <AnimatedText delay={0.2}>
            <p className="leading-relaxed">
              Коли ви змінюєте пристрій доступу до інтернету, наприклад, роутер, необхідно очистити прив'язку по MAC-адресі, щоб встановити новий пристрій. Це забезпечить <span className="font-semibold text-blue-500">безперебійний доступ до інтернету</span> з вашого нового обладнання.
            </p>
          </AnimatedText>
          ...
          <AnimatedText delay={0.4}>
            <p className="leading-relaxed">
              Пам'ятайте, що після очищення MAC-адреси вам потрібно буде <span className="font-semibold text-blue-600">перезавантажити ваше нове інтернет-обладнання</span>, щоб зміни вступили в силу. Якщо у вас виникнуть будь-які питання під час цього процесу, наша служба підтримки завжди готова вам допомогти.
            </p>
          </AnimatedText>
        </div>
      </DialogContent>
