...
export default function StaticIpDialog({ open, handleClose, handleAction }) {
  ...
  // Отримуємо дані користувача зі стору з безпечним доступом
  ...
  // Оновлюємо телефон тільки якщо він є в даних користувача
  useEffect(() => {
  ...
  // Оновлена функція обробки зміни номера телефону
  ...
  return (
    ...
    <div className="space-y-4">
      <h3 className="text-xl font-semibold text-red-600">Для чого потрібна статична IP-адреса?</h3>
